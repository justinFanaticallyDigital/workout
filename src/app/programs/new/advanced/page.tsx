...
export default function AdvancedNewProgramPage() {
  ...
  return (
    <div className="min-h-screen bg-ft-bg text-ft-white p-6 max-w-3xl mx-auto">
      ...
      <p className="text-ft-dim text-sm font-body mb-6">
        Skip the picker and configure your program manually
      </p>
              ...
              <Link href={tier.href}>
                <Card className="hover:border-ft-dim transition-colors cursor-pointer">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h2 className="font-display text-base mb-0.5">
                        {tier.title}
                      </h2>
                    ...
                    <div className="flex items-end gap-3">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className="w-full bg-ft-bg border border-ft-card rounded-ft px-3 py-2 text-sm font-body text-ft-white placeholder:text-ft-muted focus:outline-none focus:border-ft-dim transition-colors"
                        />
                      </div>
                      <button
                        onClick={handleQuickCreate}
                        disabled={saving || !quickName.trim()}
                        className="bg-ft-white text-ft-bg font-body text-sm font-bold px-4 py-2 rounded-ft hover:bg-ft-light transition-colors disabled:opacity-50"
                      >
                        {saving ? "..." : "Create & Start"}
                      </button>
                    </div>
