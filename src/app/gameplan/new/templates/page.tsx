...
/**
 * R14 — Gameplan templates list at `/gameplan/new/templates`.
 *
 * Primary entry from /gameplan/new Step1Welcome's "Pick a Gameplan"
 * CTA. Renders the 8 spec §3.1 templates as cards (level chip, meta
 * grid, periodization tag, goal-weighting bar). Tapping a card routes
 * to /gameplan/new/templates/[slug]/customize where the per-template
 * wizard collects customization answers and POSTs to /api/programs/clone.
 */
...
function TemplateCard({ template }: { template: ProgramTemplate }) {
  ...
  return (
    <Link
      href={`/gameplan/new/templates/${slug}/customize`}
