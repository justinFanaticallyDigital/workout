...
function useTweaks(defaults) {
  ...
  // Accepts either ('key', val) or an object of {key: val, …} so callers can
  // batch updates. Both shapes funnel through the same setValues + postMessage.
  const setTweak = React.useCallback((keyOrObj, val) => {
    const edits = typeof keyOrObj === 'string'
      ? { [keyOrObj]: val }
      : (keyOrObj || {});
